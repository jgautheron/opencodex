...
export const de: Record<TKey, string> = {
  ...
  "dash.mem.growth": "RSS-Drift / Stunde",
  ...
  "storage.cleanup.quarantineNote": "Dateien wandern nach .trash unter CODEX_HOME. In dieser Version gibt es keine App-Wiederherstellung — behalte den Ordner oder verschiebe Dateien manuell anhand von manifest.json zurück.",
