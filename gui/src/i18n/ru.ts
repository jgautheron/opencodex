...
export const ru: Record<TKey, string> = {
  ...
  "dash.mem.hint": "Диагностика среды выполнения только для чтения. Плоская куча JS при растущем RSS указывает на нативную память среды, а не на утечку на уровне приложения.",
